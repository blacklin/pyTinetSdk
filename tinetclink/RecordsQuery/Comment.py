'''留言记录
@Auther: lin
@Date: 2019-10-09 17:30:29.496894'''
class Comment:
    def __init__(self, core):
        self.core = core

    def list_comments(self,hiddenType=None,customerNumber=None,hotline=None,startTime=None,endTime=None,offset=None,limit=None):
        """
        查询留言记录列表
